...
description = "Given a DNAnexus project ID, or a file containing multiple DNAnexus project IDs (one per line), adds one or more properties to each project. Properties are specified as positional key=value arguments."

parser = ArgumentParser(description=description)
group = parser.add_mutually_exclusive_group(required=True)
group.add_argument("--dx-project-id",help="The DNAnexus project ID to add properties too.")
group.add_argument("--infile",help="File of DNAnexus project IDs, one per line. Empty lines and lines starting with '#' will be skipped.")
parser.add_argument("props",nargs='+',help="One or more key=value positional arguments, each representing a property key and value pair.")
