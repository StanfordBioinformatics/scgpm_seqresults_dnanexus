...
parser.add_argument("-b","--billing-account",required=True,help="The name of the DNAnexus billing account that the project belongs to. This will only be used to restrict the search of projects.")
